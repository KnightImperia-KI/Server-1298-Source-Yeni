...
struct _EVENT_STATUS
{
	...
	uint16_t ElMoradKillCount;
	uint16_t KarusKillCount;
	uint16_t ElmoDeathCount[MAX_TEMPLE_EVENT_ROOM];
	uint16_t KarusDeathCount[MAX_TEMPLE_EVENT_ROOM];
	uint8_t m_sKarusBdw;
	uint8_t m_sElmoBdw;
	time_t OurRoomTeleportTime[MAX_TEMPLE_EVENT_ROOM];
	bool OurRoomIsTeleported[MAX_TEMPLE_EVENT_ROOM];
	bool isAttackable[MAX_TEMPLE_EVENT_ROOM];
	bool waiting4TP[MAX_TEMPLE_EVENT_ROOM];
	bool isActive;


	uint32_t	m_nBorderDefenseWarPrizeWonItemNo1;
	uint32_t	m_nBorderDefenseWarPrizeWonItemNo2;
	uint32_t	m_nBorderDefenseWarPrizeWonItemNo3;
	uint32_t	m_nBorderDefenseWarPrizeWonItemNo4_K;
	uint32_t	m_nBorderDefenseWarPrizeWonItemNo4_H;
	uint32_t	m_nBorderDefenseWarPrizeWonLoyalty;
	uint32_t	m_nBorderDefenseWarPrizeWonExp;
	uint32_t	m_nBorderDefenseWarPrizeLoserLoyalty;
	uint32_t	m_nBorderDefenseWarPrizeLoserItem;
	uint32_t	m_nBorderDefenseWarPrizeLoserExp;
	uint32_t	m_nBorderDefenseWarMAXLEVEL;
	uint32_t	m_nBorderDefenseWarMINLEVEL;
