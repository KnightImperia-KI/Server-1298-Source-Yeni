...
public:	
	...
	void TempleEventKickOutUser(uint16_t nEventRoom);
	void TempleEventReset();
	void TerminationFinish(uint16_t nEventRoom);
	void TemplEventBDWSendJoinScreenUpdate(CUser* pUser);
	void TempleEventFinish(uint16_t nEventRoom);
	...
	uint32_t	m_nBorderDefenseWarPrizeWonItemNo1[BORDER_DEFENSE_WAR_EVENT_COUNT];
	uint32_t	m_nBorderDefenseWarPrizeWonItemNo2[BORDER_DEFENSE_WAR_EVENT_COUNT];
	uint32_t	m_nBorderDefenseWarPrizeWonItemNo3[BORDER_DEFENSE_WAR_EVENT_COUNT];
	uint32_t	m_nBorderDefenseWarPrizeWonItemNo4_K[BORDER_DEFENSE_WAR_EVENT_COUNT];
	uint32_t	m_nBorderDefenseWarPrizeWonItemNo4_H[BORDER_DEFENSE_WAR_EVENT_COUNT];
	uint32_t	m_nBorderDefenseWarPrizeWonLoyalty[BORDER_DEFENSE_WAR_EVENT_COUNT];
	uint32_t	m_nBorderDefenseWarPrizeWonExp[BORDER_DEFENSE_WAR_EVENT_COUNT];
	uint32_t	m_nBorderDefenseWarPrizeLoserLoyalty[BORDER_DEFENSE_WAR_EVENT_COUNT];
	uint32_t	m_nBorderDefenseWarPrizeLoserItem[BORDER_DEFENSE_WAR_EVENT_COUNT];
	uint32_t	m_nBorderDefenseWarPrizeLoserExp[BORDER_DEFENSE_WAR_EVENT_COUNT];
	uint32_t	m_nBorderDefenseWarMAXLEVEL[BORDER_DEFENSE_WAR_EVENT_COUNT];
	uint32_t	m_nBorderDefenseWarMINLEVEL[BORDER_DEFENSE_WAR_EVENT_COUNT];
	...
	void UpdateEventUser(CUser* pUser, uint16_t nEventRoom);
